...
-- Table `DYK_db`.`STATUS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DYK_db`.`STATUS` (
...
CREATE TABLE IF NOT EXISTS `DYK_db`.`USUARIO` (
  ...
  INDEX `fk_USUARIO_STATUS_idx` (`COD_STATUS` ASC) VISIBLE,
  CONSTRAINT `fk_USUARIO_STATUS`
    FOREIGN KEY (`COD_STATUS`)
    REFERENCES `DYK_db`.`STATUS` (`COD_STATUS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DYK_db`.`PERSONAGEM` (
  ...
  INDEX `fk_PERSONAGEM_STATUS1_idx` (`COD_STATUS` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `DYK_db`.`PERGUNTA_has_RESPOSTA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DYK_db`.`PERGUNTA_has_RESPOSTA` (
