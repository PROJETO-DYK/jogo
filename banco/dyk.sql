...
CREATE TABLE IF NOT EXISTS `DYK_db`.`USUARIO` (
  ...
  `PERSONAGEM_COD_PERSONAGEM` INT NOT NULL,
  PRIMARY KEY (`COD_USUARIO`),
  UNIQUE INDEX `EMAIL_UNIQUE` (`EMAIL` ASC) VISIBLE,
  INDEX `fk_USUARIO_PERSONAGEM1_idx` (`PERSONAGEM_COD_PERSONAGEM` ASC) VISIBLE,
  CONSTRAINT `fk_USUARIO_PERSONAGEM1`
    FOREIGN KEY (`PERSONAGEM_COD_PERSONAGEM`)
...
CREATE TABLE IF NOT EXISTS `DYK_db`.`HABILIDADE` (
  ...
  INDEX `fk_HABILIDADE_PERSONAGEM1_idx` (`PERSONAGEM_COD_PERSONAGEM` ASC) VISIBLE,
